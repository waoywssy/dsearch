...
gj.tree.plugins.checkboxes = {
    ...
    private: {
        ...
        nodeDataBound: function ($tree, $node, id, record) {
            ...
            $checkbox.on('click', function (e) {
                ...
                // add an extra event, on update here
                gj.tree.plugins.checkboxes.events.onUpdate($tree, $node, record, $checkbox.state());
    ...
    events: {
        ...
        onUpdate: function($tree, $node, record, state){
            return $tree.triggerHandler('onUpdate', [$node, record, state]);
        }
    },
